...
import { provincePath, statsPath } from "@/lib/seo/urls";
...
export default async function ProvinceStats({ params }: Props) {
  ...
  const [breakdown, stats, dataAsOf] = await Promise.all([getStatusBreakdown(province.slug), listProvinceIndustryStats(province.slug), getDataAsOf()]);
