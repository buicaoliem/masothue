...
/** Magnifier icon + "masothuedn" wordmark, linking home. Colors come from --brand-navy / --accent. */
  ...
  return (
    <Link href="/" className={styles.brand} aria-label="masothuedn.com - Trang chủ">
      <svg viewBox="0 0 42 42" fill="none" className={styles.brandIcon} aria-hidden="true">
        ...
        <line x1="26" y1="26" x2="35" y2="35" stroke="var(--accent,#1f7a52)" strokeWidth="4" strokeLinecap="round" />
      </svg>
