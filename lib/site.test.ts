...
test("normalizeSiteUrl forces https", () => {
  assert.equal(normalizeSiteUrl("http://masothuedn.com"), "https://masothuedn.com");
});
...
test("normalizeSiteUrl leaves an already-normalized URL unchanged", () => {
  assert.equal(normalizeSiteUrl("https://masothuedn.com"), "https://masothuedn.com");
});
...
test("SITE_URL is the canonical apex host with no trailing slash", () => {
  assert.equal(SITE_URL, "https://masothuedn.com");
});
